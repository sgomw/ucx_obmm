...
#define UCT_OBMM_CC_LOCAL_REGION_SIZE   (32ul * 1024ul * 1024ul)
...
{
    if (region_length < UCT_OBMM_CC_LOCAL_REGION_SIZE) {
        return UCS_ERR_NO_RESOURCE;
    }

    *pool_base_p   = region_base;
    *pool_length_p = UCT_OBMM_CC_LOCAL_REGION_SIZE;
    return UCS_OK;
}
                                   ...
                                   size_t *data_length_p)
{
    ...
    *data_offset_p = UCT_OBMM_CC_LOCAL_REGION_SIZE;
