...
cache per lane and publishes `lane->ctl.tail` lazily in batches (currently half
the lane depth) rather than after every consumed message, while still forcing a
